                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(children: [
                          Icon(Icons.extension_outlined, size: 14, color: colorScheme.onSurfaceVariant),
                          const SizedBox(width: 4),
                          Flexible(
                            child: Text(widget.historyItem.adapterName,
                                style: theme.textTheme.bodySmall?.copyWith(color: colorScheme.onSurfaceVariant),
                                overflow: TextOverflow.ellipsis,
                                maxLines: 1),
                          ),
                ...
                Column(
                  ...
                  children: [
                    if (!widget.showDelete) ...[
                      ...
                      IconButton(
                        icon: Icon(Icons.open_in_new, size: 20, color: colorScheme.onSurfaceVariant),
                        tooltip: '番剧详情',
                        onPressed: () => Modular.to.pushNamed('/info/', arguments: widget.historyItem.bangumiItem),
                      ),
                    ],
                    if (widget.showDelete)
                      IconButton(
                        ...
                        tooltip: '删除记录',
                        onPressed: () => widget.onDeleted?.call(),
                      ),
                  ],
                ),
              ],
